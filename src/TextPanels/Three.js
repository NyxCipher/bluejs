     ...
     <>
        <div className="texts-body texts-console-outer">
            <ul class="bp5-dark bp5-tab-list {{.modifier}}" role="tablist">
                <H4 className="bp5-dark">U   B   E   R</H4>
            </ul>
        ...
        <Card interactive={true} elevation={Elevation.FIVE} className="texts-console-two">
            <H3><Button className="bp5-icon-code"/> U   B   E   R &nbsp; 1   3   3   7</H3>
            <p>
                Uber Elite, The 1337 of each category of Hat. Quick note, Port 1337 was used by the CDC, Cult of the Dead Cow, for their backdoor, Back-Oriface. They invented 1337-Speak. <i>See Book: Cult of the Dead Cow".</i>
            </p>
            <p>
                Essentially, you write your own Shell Code, your own Software, exploits, and contribute to the community and give back. It also helps if you earn a CVE or two. Maybe one
                also engages in the sale of Exploits on the ocassion, like a walk in the park for some, "Hmm, I think I'll sell an exploit for $100k today." kind of thinking and thought pattern -
                "Well, maybe this exploit is too powerful, we should give it to the public instead." The devil you know...I mean one can also hack a major corporation and be Uber 1337 too.
            </p>
            <p>
                How does one get here? By following those who came before him or her, or them. Master ones own craft and redifine it. In other words, you are <strong>Zen</strong>. You are <strong>Sealth</strong>.
            </p>
