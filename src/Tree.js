...
import { Dialog, DialogBody, Card, Elevation, Button, Collapse, Pre, Classes, ContextMenu, Icon, Intent, Tooltip, Tree, type TreeNodeInfo } from "@blueprintjs/core";
...
export const TreeExample: React.FC<ExampleProps> = props => {
    ...
    return (
        ...
        <Card interactive={true} elevation={Elevation.FIVE} className='card-tree'>
